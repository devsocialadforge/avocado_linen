...
function Carousel({
  ...
  const allPlugins = React.useMemo(() => {
    const pluginArray = [];
    if (autoplayPlugin) pluginArray.push(autoplayPlugin);
    if (plugins) {
    ...
    return pluginArray.length > 0 ? pluginArray : undefined;
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute size-8 hidden md:block rounded-full",
        orientation === "horizontal"
      ...
      {...props}
    >
      <ArrowLeft className="text-center mx-auto fill-current" />
...
function CarouselNext({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ArrowRight className="text-center mx-auto fill-current text-black" />
